...
Custom profile commands never pass through a shell. BDFL owns provider/profile selection, resume, MCP, model, effort, permission, hook/settings, notification, and role flags.
