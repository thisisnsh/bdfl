...
Give every new plan a concise imperative title of at most 72 characters and a separate Summary containing 1–5 commit-ready bullet points. Summary is independently approved and becomes the final integration commit body. Treat it as immutable while approved: ask the user to remove Summary approval before publishing a revision that changes it.
