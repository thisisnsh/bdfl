---
name: activate
description: Activate BDFL for substantial coding work with managed parallel agents, versioned plans, isolated Git worktrees, explicit approvals, and validated integration. Use only when the user explicitly invokes the BDFL activation skill, optionally with a provider:model:effort argument.
---
