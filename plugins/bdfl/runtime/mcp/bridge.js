...
class ControlServer {
  constructor({ planService, workerService, host = '127.0.0.1', port = 41000 + crypto.randomInt(20000), heartbeatTimeout = 15000, heartbeatCheck = 5000, onProxyLost = null, onToolSuccess = null } = {}) { this.planService = planService; this.workerService = workerService; this.host = host; this.port = port; this.heartbeatTimeout = heartbeatTimeout; this.heartbeatCheck = heartbeatCheck; this.onProxyLost = onProxyLost; this.onToolSuccess = onToolSuccess; this.capabilities = new Map(); this.proxies = new Map(); }
  ...
  setToolSuccessHandler(handler) { this.onToolSuccess = handler; return this; }
