...
|---|---|---|
| `ci.yml` | Every push and pull request | Runs the test suite and manifest/package validation on Node.js 20 and 22. |
| `sync-plugin.yml` | Pull requests that change canonical or packaged sources | Fails when `plugins/bdfl/runtime/` has drifted from canonical `src/`. |
